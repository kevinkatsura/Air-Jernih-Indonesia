          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-heading font-bold text-gray-900 text-lg">Pengalaman 15+ Tahun</h3>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-heading font-bold text-gray-900 text-lg">Fokus Residensial &amp; Kontraktor</h3>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-heading font-bold text-gray-900 text-lg">Preventive Maintenance System</h3>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-heading font-bold text-gray-900 text-lg">Respons Cepat &amp; Komunikatif</h3>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-heading font-bold text-gray-900 text-lg">Dokumentasi &amp; Evaluasi Berkala</h3>
                  <p className="text-gray-600">Laporan lengkap dan evaluasi rutin untuk monitoring kondisi kolam.</p>
                </div>
              </div>
            </div>
          </div>
